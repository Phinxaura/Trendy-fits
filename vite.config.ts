...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['vite.svg', 'favicon.ico', 'robots.txt', "icons/*.png"],
      manifest: {
        name: 'My Shopping Website Trendy Fits',
        short_name: 'Trendy Fits',
        description: 'A Progressive shop App built with Vite!',
        theme_color: '#ffffff',
